...
<head>
  ...
  <title>Sistema Ventas Grazia</title>
  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <a href="" class="logo">
        ...
        <span class="logo-lg"><b>Grazia</b></span>
      </a>
              ...
              <ul class="dropdown-menu">
                ...
                <li class="user-footer">
                  ...
                  <div class="pull-right">
                    <a href="../ajax/usuario.php?op=salir" class="btn btn-default btn-flat" style="position: relative;left: -100px;">Cerrar Sesion</a>
                  </div>
                </li>
              </ul>
            </li>
        ...
        <ul class="sidebar-menu">
          ...
          if ($_SESSION['almacen'] == 1) {
            echo '<li id="mAlmacen" class="treeview">
              ...
              <ul class="treeview-menu">
                <li id="lArticulos"><a href="articulo.php"><i class="fa-solid fa-shirt"></i> Artículos</a></li>
          ...
          if ($_SESSION['compras'] == 1) {
            echo '<li id="mCompras" class="treeview">
              ...
              <ul class="treeview-menu">
                <li id="lIngresos"><a href="ingreso.php"><i class="fa-solid fa-basket-shopping"></i> Ingresos</a></li>
